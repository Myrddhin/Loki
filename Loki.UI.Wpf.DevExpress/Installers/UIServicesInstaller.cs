...
namespace Loki.UI.Wpf.DevExpress
{
    public class UIInstaller : LokiContextInstaller
    {
        public override void Install(IObjectContext context)
        {
            ...
            context.Register(Element.For<ITemplatingEngine>().ImplementedBy<DevExpressWpfTemplatingEngine>());
            context.Register(Element.For<ISignalManager>().ImplementedBy<WpfSignalManager>());
            context.Register(Element.For<IWindowManager>().ImplementedBy<DevExpressWpfWindowManager>());
